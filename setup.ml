...
(* OASIS_START *)
(* DO NOT EDIT (digest: 23e466679d806a3ab3a11ea6a84a08fd) *)
(*
...
let setup_t =
  {
       ...
       CustomPlugin.main
         {
            CustomPlugin.cmd_main =
              [
                 (OASISExpr.EBool true,
                   ("PREFIX=$prefix", ["omake"; "--configure"; "install"]))
              ];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\180\185f\165\145\171eeE\005\026=\006;Eo";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
